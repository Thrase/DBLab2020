...
namespace MyLibrary
{
    public partial class FormAdmin : Form
    {
        ...
        public FormAdmin(string account, int getauth)
        {
            ...
            rtseats = AdminBLL.SimpleQuery3(sql);
        ...
        private void btn_searchseats_Click_1(object sender, EventArgs e)
        {
        ...
        private void btn_chooseseats_Click(object sender, EventArgs e)
        {
            ...
            if (ExecuteSql.Executesql(sql) > 0)
            {
                ...
                sql = "select user_seated from userinfo where login_account='" + acc + "'";
                rtseats = AdminBLL.SimpleQuery3(sql);
                label_ifs.Text = rtseats;
                btn_chooseseats.Visible = false;
                btn_zl.Visible = true;
